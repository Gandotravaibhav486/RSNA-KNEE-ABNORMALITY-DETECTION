...
| `exp-20260914-09-silence-per-finding` | 2026-09-14 | loss | Silence ⇒ negative for Baker's / Medial OA (gold+ 0.03 / 0.00 when silent), unknown for Synovitis (0.34) | community's targeted repair paid +0.0093; blanket *lost* 0.0068 | 0.7794 | — | — | — | — | **proposed — next** |
...
| `exp-20260915-15-epochs-screened` | 2026-09-16 | training | 4 vs 12 epochs at **p2/t2**, on the screening metric | gold could not resolve exp-13; 12 epochs costs 3× GPU | 0.7501 | — | — | — | — | **proposed** |
| `exp-20260916-18-confidence-weight` | 2026-09-16 | loss | Weight the loss by `2·\|p−0.5\|` — the L1 key is soft, so this sends "not addressed" cells to zero weight | the key's own authors recommend it; we currently treat a 0.51 and a 0.99 alike | 0.7794 | — | — | — | — | **proposed** |
...
| `exp-20260916-20-blend-keys` | 2026-09-16 | data-analysis | Blend L1 with a second, decorrelated key | public v4 gained most from its *weakest* partner (rank corr 0.718) | 0.8927 | — | — | — | — | **proposed** |
