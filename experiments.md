...
| [`exp-20260913-03-coverage-ceiling`](experiments/exp-20260913-03-coverage-ceiling.md) | 2026-09-13 | paper | Compute the achievable ceiling: what macro AUC is reachable given current label coverage per target, assuming a perfect image model | Tells us whether to spend on labels or on models — no GPU needed | 0.6879 | — | — | — | — | proposed |
